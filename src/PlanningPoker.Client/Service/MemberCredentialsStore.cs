...
namespace PlanningPoker.Client.Service
{
    /// <summary>
    ...
    public class MemberCredentialsStore : IMemberCredentialsStore
    {
        ...
        public async Task<MemberCredentials?> GetCredentialsAsync(bool permanentScope)
        {
            try
            {
                return await _jsRuntime.InvokeAsync<MemberCredentials?>("Ploker.PlanningPoker.getMemberCredentials", permanentScope);
            }
            catch (Exception)
            {
        ...
        public async Task SetCredentialsAsync(MemberCredentials? credentials)
        {
            try
            {
                await _jsRuntime.InvokeAsync<object>("Ploker.PlanningPoker.setMemberCredentials", credentials);
            }
            catch (Exception)
            {
                // Ignore exception. User can connect manually.
