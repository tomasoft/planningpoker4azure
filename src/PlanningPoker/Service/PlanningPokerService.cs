...
namespace PlanningPoker.Service
{
    ...
    public class PlanningPokerService : ControllerBase
    {
        ...
        public PlanningPokerService(IPlanningPoker planningPoker, DateTimeProvider dateTimeProvider, DeckProvider deckProvider)
        {
        ...
        /// </summary>
        public IPlanningPoker PlanningPoker { get; private set; }
        ...
        public void SubmitEstimation(string teamName, string memberName, double estimation)
        {
            ...
            using (var teamLock = PlanningPoker.GetScrumTeam(teamName))
            {
                ...
                if (member != null)
                {
                    member.Estimation = new Domain.Estimation(domainEstimation);
                }
            }
        }
