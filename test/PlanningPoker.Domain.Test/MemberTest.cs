...
namespace PlanningPoker.Domain.Test
{
    [TestClass]
    public class MemberTest
    {
        private static readonly DateTime[] _nowData = new[]
        {
        ...
        private static readonly TimeSpan[] _durationData = new[]
        {
            new TimeSpan(1, 5, 45),
            new TimeSpan(0, 45, 0),
            new TimeSpan(0, 0, 1),
        ...
        private static readonly DateTime[] _expectedEndTimeData = new[]
        {
        ...
        public static IEnumerable<object[]> TimerTestData => Enumerable.Range(0, 3)
            .Select(i => new object[] { _nowData[i], _durationData[i], _expectedEndTimeData[i] });
        ...
        public void StartTimer_DurationSpecified_MemberGetTimerStartedMessage()
        {
            // Arrange
            var dateTimeProvider = new DateTimeProviderMock();
            dateTimeProvider.SetUtcNow(_nowData[0]);
            var team = ScrumTeamTestData.CreateScrumTeam("test team", dateTimeProvider: dateTimeProvider);
            team.SetScrumMaster("master");
            var member = (Member)team.Join("member", false);

            // Act
            member.StartTimer(_durationData[0]);
            ...
            Assert.AreEqual(_expectedEndTimeData[0], timerMessage.EndTime);
        }
        ...
        public void StartTimer_DurationSpecified_ScrumMasterGetTimerStartedMessage()
        {
            // Arrange
            var dateTimeProvider = new DateTimeProviderMock();
            dateTimeProvider.SetUtcNow(_nowData[1]);
            var team = ScrumTeamTestData.CreateScrumTeam("test team", dateTimeProvider: dateTimeProvider);
            var master = team.SetScrumMaster("master");
            var member = (Member)team.Join("member", false);
            ...
            // Act
            master.ClearMessages();
            member.StartTimer(_durationData[1]);
            ...
            Assert.IsInstanceOfType(message, typeof(TimerMessage));
            var timerMessage = (TimerMessage)message;
            Assert.AreEqual(_expectedEndTimeData[1], timerMessage.EndTime);
        }
        ...
        public void StartTimer_DurationSpecified_ObserverGetTimerStartedMessage()
        {
            // Arrange
            var dateTimeProvider = new DateTimeProviderMock();
            dateTimeProvider.SetUtcNow(_nowData[2]);
            var team = ScrumTeamTestData.CreateScrumTeam("test team", dateTimeProvider: dateTimeProvider);
            var master = team.SetScrumMaster("master");
            ...
            // Act
            master.StartTimer(_durationData[2]);
            ...
            Assert.IsInstanceOfType(message, typeof(TimerMessage));
            var timerMessage = (TimerMessage)message;
            Assert.AreEqual(_expectedEndTimeData[2], timerMessage.EndTime);
        }
        ...
        public void CancelTimer_TimerIsStarted_TimerEndTimeIsNull()
        {
            ...
            var master = team.SetScrumMaster("master");
            var member = (Member)team.Join("member", false);
            master.StartTimer(_durationData[0]);
