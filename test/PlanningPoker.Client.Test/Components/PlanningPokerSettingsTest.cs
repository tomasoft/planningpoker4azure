...
using PlanningPoker.Client.Test.Controllers;
...
namespace PlanningPoker.Client.Test.Components
{
    ...
    public sealed class PlanningPokerSettingsTest : IDisposable
    {
        ...
        public async Task ChangeDeckCommand_DeckIsChangedMessageIsDisplayed()
        {
            ...
            _context.JSInterop.SetupVoid("Ploker.PlanningPoker.registerOnModalHidden", _ => true)
                .SetVoidResult();
            ...
            _context.JSInterop.VerifyInvoke("Ploker.PlanningPoker.registerOnModalHidden");
        }
        ...
        public async Task ModalDialogIsHidden_DeckIsChangedMessageIsHidden()
        {
            ...
            _context.JSInterop.SetupVoid(
                "Ploker.PlanningPoker.registerOnModalHidden",
                invocation =>
                {
