...
namespace PlanningPoker.Client.Test.Service
{
    [TestClass]
    public class TimerSettingsRepositoryTest
    {
            ...
            int expectedTimeInSeconds)
        {
            ...
            jsRuntime.Setup(o => o.InvokeAsync<string?>("Ploker.PlanningPoker.getTimerDuration", It.IsAny<object?[]>()))
                .ReturnsAsync(loadedStringValue);

            var result = await target.GetTimerDurationAsync();

            jsRuntime.Verify(o => o.InvokeAsync<string?>("Ploker.PlanningPoker.getTimerDuration", Array.Empty<object?>()));
            ...
            string expectedStringValue)
        {
            ...
            jsRuntime.Setup(o => o.InvokeAsync<IJSVoidResult>("Ploker.PlanningPoker.setTimerDuration", It.IsAny<object?[]>()))
            ...
            jsRuntime.Setup(o => o.InvokeAsync<IJSVoidResult>("Ploker.PlanningPoker.setTimerDuration", It.Is<object?[]>(a => a.Length == 1)));
